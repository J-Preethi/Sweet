...
namespace OnlineSweetShopy.Controllers
{
    public class EventBookingReqsController : Controller
    {
        ...
        public EventBookingReqsController(ShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.EventBookingReqs != null ? 
                          ...
                          Problem("Entity set 'ShopContext.EventBookingReqs'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ShopContext.EventBookingReqs'  is null.");
            }
            var eventBookingReq = await _context.EventBookingReqs.FindAsync(id);
            if (eventBookingReq != null)
            {
