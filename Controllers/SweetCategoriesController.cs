...
namespace OnlineSweetShopy.Controllers
{
    public class SweetCategoriesController : Controller
    {
        ...
        public SweetCategoriesController(ShopContext context)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
              return _context.SweetCategories != null ? 
                          ...
                          Problem("Entity set 'ShopContext.SweetCategories'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ShopContext.SweetCategories'  is null.");
            }
            var sweetCategory = await _context.SweetCategories.FindAsync(id);
            if (sweetCategory != null)
            {
