...
namespace OnlineSweetShopy.Controllers
{
    public class SweetProductsController : Controller
    {
        ...
        public SweetProductsController(ShopContext context)
        {
            _context = context;
        }
        ...
        {
            var shopContext = _context.SweetProducts.Include(s => s.categ);
            return View(await shopContext.ToListAsync());
        }
        public ActionResult ProductList(int id)
        {
            var shopContext = _context.SweetProducts.Include(s => s.categ).Where(e=>e.categID== id);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ShopContext.SweetProducts'  is null.");
            }
            var sweetProduct = await _context.SweetProducts.FindAsync(id);
            if (sweetProduct != null)
            {
